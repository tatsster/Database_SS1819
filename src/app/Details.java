    ...
    public int getPatientList(String docID) throws SQLException {
        ...
        if (patientList.next() == false) {
            ...
            System.out.format("|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|%s|\n",
                    ...
                    StringUtils.center("Day of Birth", 20),
                    StringUtils.center("Gender", 10),
                    StringUtils.center("Phone no.", 15),
                    StringUtils.center("Address", 60),
                    StringUtils.center("Admission Date", 20),
                    StringUtils.center("Discharge Date", 20),
                    StringUtils.center("Diagnosis", 30),
                    StringUtils.center("Sickroom", 15),
                    StringUtils.center("Fee", 10),
                    StringUtils.center("Caring Nurse ID", 20),
                    StringUtils.center("Treatment ID", 15),
                    StringUtils.center("Treatment Start Date", 25),
                    StringUtils.center("Treatment End Date", 20),
                    StringUtils.center("Result", 65));
